...
function validalas() {
    ...
    var szuroTel = /{+}+[1-9]{9,}/;
    var telellen = ID("tel").value;
    var telHiba = "";
    var telAdat = "";
    if(!szuroTel === telellen){
        telHiba += "Telefon számod:  <br> ";
        ID("telellen").style.border="2px solid red";
    }else{
        ID("telellen").style.border="none";
        telAdat+="E-mail: "+telellen+"<br>";
    }
    $("aside section:nth-child(1) p")[0].innerHTML = telHiba;
    $("aside section:nth-child(2) p")[0].innerHTML = telAdat;
